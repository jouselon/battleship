...
public class Main {
  public static void main(String[] args) {
    ...
    while (undetectedShipNumber > 0) {
      ...
      gameBoard = updateGameBaord(gameBoard, guessCoordinates, locationViewUpdate);
      printGameBoard(gameBoard, water, ship);
  ...
  private static char[][] updateGameBaord(char[][] gameBoard, int[] guessCoordinates, char locationViewUpdate) {
